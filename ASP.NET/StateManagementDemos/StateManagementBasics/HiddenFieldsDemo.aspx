<%@ Page Language="C#" UnobtrusiveValidationMode="none" AutoEventWireup="true" CodeBehind="HiddenFieldsDemo.aspx.cs" Inherits="StateManagementBasics.HiddenFieldsDemo" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <br />
            <br />
        <asp:HiddenField ID="HiddenFieldUsername" runat="server" OnValueChanged="HiddenFieldUsername_ValueChanged" />
        <br />
        <asp:HiddenField ID="HiddenFieldEmail" runat="server" />
        <br />
            <br />
            <asp:Label ID="lblUsernameOp" runat="server"></asp:Label>
            <br />
            <br />
            <asp:Label ID="lblPasswordOp" runat="server"></asp:Label>
